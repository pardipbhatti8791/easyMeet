                ...
                {switchAvailability == true && (
                    <div>
                        <div className='small-size text-left opacity-8 py-2'>
                            When your status is set to ‘Available’, your Requestors and You will receive browser and
                            email notifications in order to start your meetings.
                        </div>
                        <div className='form-group mb-0 px-0 py-3'>
                            ...
                            <div className='radio'>
                                ...
                                />
                                <label for='radio-1' className='radio-label small-size opacity-8'>
                                    10 minutes
                                </label>
                            </div>
                            <div className='radio'>
                                <input
                                    ...
                                    onChange={e => changeAvailabilityDuration(e.target.value)}
                                />
                                <label for='radio-2' className='radio-label small-size opacity-8'>
                                    30 minutes
                                </label>
                            </div>
                            <div className='radio'>
                                <input
                                    ...
                                    onChange={e => changeAvailabilityDuration(e.target.value)}
                                />
                                <label for='radio-3' className='radio-label small-size opacity-8'>
                                    1 hour
                                </label>
                            </div>
                            <div className='radio'>
                                <input
                                    ...
                                    onChange={e => changeAvailabilityDuration(e.target.value)}
                                />
                                <label for='radio-4' className='radio-label small-size opacity-8'>
                                    2 hours
                                </label>
                            </div>
                            <div className='radio'>
                                <input
                                    ...
                                    onChange={e => changeAvailabilityDuration(e.target.value)}
                                />
                                <label for='radio-5' className='radio-label small-size opacity-8'>
                                    4 hours
                                </label>
                            </div>
                            <div className='radio'>
                                <input
                                    ...
                                    onChange={e => changeAvailabilityDuration(e.target.value)}
                                />
                                <label for='radio-6' className='radio-label small-size opacity-8'>
                                    8 hours
                                </label>
                            </div>
                        </div>
