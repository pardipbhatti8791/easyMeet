    ...
    <div className='profile-photo-dialog'>
      ...
      <div image className='modal-body pb-0'>
        ...
        <div className={previewImage != null ? 'd-flex change-cropbtn' : ''}>
          <div
            className={previewImage != null ? 'd-block text-right' : 'd-none'}
          >
            <button
              className='btn primary-btn ml-auto mb-1 medium-size updatePhoto'
              onClick={getCropData}
            >
              Crop Image
            </button>
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={
                            previewImage != null ? 'd-block' : 'd-none'
                          }
                        >
        ...
        <div
          className={previewImage != null ? 'd-block crop-imagebox' : 'd-none'}
        >
          <img
            style={{ width: '100%' }}
